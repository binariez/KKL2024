...
?>
            <tr style="text-align: center; border-color: black">
                ...
                <!-- w1 -->
                <td><?= $d_cek['w1']['w1a'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w1']['w1b'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w1']['w1c'] != 'N/A' ? $d_cek['w1']['w1c'] : ''; ?></td>
                <!-- w2 -->
                <td><?= $d_cek['w2']['w2a'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w2']['w2b'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w2']['w2c'] != 'N/A' ? $d_cek['w2']['w2c'] : ''; ?></td>
                <!-- w3 -->
                <td><?= $d_cek['w3']['w3a'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w3']['w3b'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w3']['w3c'] != 'N/A' ? $d_cek['w3']['w3c'] : ''; ?></td>
                <!-- w4 -->
                <td><?= $d_cek['w4']['w4a'] == 1 ? '&#x2714' : ''; ?></td>
                <td><?= $d_cek['w4']['w4b'] == 1 ? '&#x2714' : ''; ?></td>
